...
***************************************************************************** */ var t = function (
    ...
    function E(e, t) {
      ...
      else if ((a.id && l.push("#" + a.id), (n = a.className) && y(n))) for (i = n.split(/\s+/), o = 0; o < i.length; o++) l.push("." + i[o]);
    ...
    function O(e) {
      return (
        ...
        { user: e.publicKey || "", protocol: e.protocol, publicKey: e.publicKey || "", pass: e.pass || "", host: e.host, port: e.port || "", path: e.path || "", projectId: e.projectId }
      );
    }
    function N(e) {
      var t =
        "string" == typeof e
          ? (function (e) {
              ...
              return O({ host: l, pass: a, path: h, projectId: d, port: u, protocol: i, publicKey: r });
            })(e)
          : O(e);
      return (
        (function (e) {
          if (C) {
            ...
            if (
              ...
              throw new x("Invalid Sentry Dsn: Invalid protocol " + i);
    ...
    var L,
      M = ["fatal", "error", "warning", "log", "info", "debug", "critical"],
      I = u(),
      j = "Sentry Logger ",
    ...
    function W(e) {
      var t = e;
      if (p(e)) t = r({ message: e.message, name: e.name, stack: e.stack }, Y(e));
      else if (w(e)) {
        var n = e;
        (t = r({ type: n.type, target: K(n.target), currentTarget: K(n.currentTarget) }, Y(n))), "undefined" != typeof CustomEvent && k(e, CustomEvent) && (t.detail = n.detail);
      }
      return t;
    }
    function K(e) {
        ...
        switch (((ae[e] = !0), e)) {
          case "console":
            !(function () {
              ...
              R.forEach(function (e) {
                e in se.console &&
                  F(se.console, e, function (t) {
                    return function () {
                      for (var n = [], i = 0; i < arguments.length; i++) n[i] = arguments[i];
                      ue("console", { args: n, level: e }), t && t.apply(se.console, n);
                    };
                  });
              });
            })();
              ...
              se.document.addEventListener("click", t, !1),
                ...
                ["EventTarget", "Node"].forEach(function (t) {
                  ...
                  n &&
                    ...
                    (F(n, "addEventListener", function (t) {
            ...
            !(function () {
              ...
              F(e, "open", function (e) {
                return function () {
                  ...
                  var i = this,
                    r = t[1],
                    s = (i.__sentry_xhr__ = { method: y(t[0]) ? t[0].toUpperCase() : t[0], url: t[1] });
                  ...
                  var o = function () {
                    if (4 === i.readyState) {
                      ...
                      ue("xhr", { args: t, endTimestamp: Date.now(), startTimestamp: Date.now(), xhr: i });
                    }
                  };
                  return (
                    "onreadystatechange" in i && "function" == typeof i.onreadystatechange
                      ? F(i, "onreadystatechange", function (e) {
                          return function () {
                            for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                ...
                F(e, "send", function (e) {
                  return function () {
                    for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                    return this.__sentry_xhr__ && void 0 !== t[0] && (this.__sentry_xhr__.body = t[0]), ue("xhr", { args: t, startTimestamp: Date.now(), xhr: this }), e.apply(this, t);
                  };
                });
            })();
            break;
          case "fetch":
            !(function () {
              ...
              F(se, "fetch", function (e) {
                return function () {
                  for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                  var i = { args: t, fetchData: { method: he(t), url: de(t) }, startTimestamp: Date.now() };
                  return (
                    ue("fetch", r({}, i)),
                    e.apply(se, t).then(
                      function (e) {
                        return ue("fetch", r(r({}, i), { endTimestamp: Date.now(), response: e })), e;
                      },
                      function (e) {
                        throw (ue("fetch", r(r({}, i), { endTimestamp: Date.now(), error: e })), e);
                      }
                    )
                  );
                };
            ...
            !(function () {
              ...
              (se.onpopstate = function () {
                ...
                var i = se.location.href,
                  r = re;
                if (((re = i), ue("history", { from: r, to: i }), e))
                  try {
                    return e.apply(this, t);
                  } catch (e) {}
              }),
                F(se.history, "pushState", t),
                F(se.history, "replaceState", t);
            })();
            break;
          case "error":
            (ye = se.onerror),
              (se.onerror = function (e, t, n, i, r) {
                return ue("error", { column: i, error: r, line: n, msg: e, url: t }), !!ye && ye.apply(this, arguments);
              });
            break;
          case "unhandledrejection":
            (ve = se.onunhandledrejection),
    ...
    function Ee(e, t) {
      ...
      if (n) {
        var i = n.mechanism;
        if (((n.mechanism = r(r(r({}, { type: "generic", handled: !0 }), i), t)), t && "data" in t)) {
      ...
      return (
        ...
        (e.prototype.applyToEvent = function (e, t) {
          ...
          return (
            ...
            this._notifyEventProcessors(a(Ke(), this._eventProcessors), e, t)
          );
        }),
    ...
    var Je = (function () {
        ...
        return (
          (e.prototype.update = function (e) {
            if (
              (void 0 === e && (e = {}),
              e.user && (!this.ipAddress && e.user.ip_address && (this.ipAddress = e.user.ip_address), this.did || e.did || (this.did = e.user.id || e.user.email || e.user.username)),
      ...
      Qe = (function () {
        ...
        return (
          ...
          (e.prototype.captureException = function (e, t) {
            ...
            return this._invokeClient("captureException", e, r(r({}, i), { event_id: n })), n;
          }),
          (e.prototype.captureMessage = function (e, t, n) {
            ...
            return this._invokeClient("captureMessage", e, t, r(r({}, s), { event_id: i })), i;
          }),
          (e.prototype.captureEvent = function (e, t) {
            var n = t && t.event_id ? t.event_id : be();
            return "transaction" !== e.type && (this._lastEventId = n), this._invokeClient("captureEvent", e, r(r({}, t), { event_id: n })), n;
          }),
          ...
          (e.prototype.startSession = function (e) {
            var t = this.getStackTop(),
              ...
              c = new Je(r(r(r({ release: o, environment: a }, n && { user: n.getUser() }), l && { userAgent: l }), e));
            if (n) {
              var h = n.getSession && n.getSession();
              h && "ok" === h.status && h.update({ status: "exited" }), this.endSession(), n.setSession(c);
            }
            return c;
          }),
    ...
    function tt() {
      var e = Ze();
      return (
        (nt(e) && !it(e).isOlderThan(Ge)) || rt(e, new Qe()),
        l()
          ? (function (e) {
              try {
                var t = Ze().__SENTRY__,
    ...
    var ot = "7";
    function at(e, t, n) {
      return { initDsn: e, metadata: t || {}, dsn: N(e), tunnel: n };
    }
    function lt(e) {
    ...
    function ut(e) {
      return (
        (t = { sentry_key: e.publicKey, sentry_version: ot }),
        Object.keys(t)
          .map(function (e) {
      ...
      return (
        (function (e) {
          ...
          Array.isArray(n)
            ...
            : "function" == typeof n && ((i = n(i)), (i = Array.isArray(i) ? i : [i]));
      ...
      vt = (function () {
        ...
        return (
          ...
          (e.prototype.captureSession = function (e) {
            this._isEnabled()
              ? "string" != typeof e.release
                ? pt && L.warn("Discarded session because of missing or non-string release")
          ...
          (e.prototype._updateSessionFromEvent = function (e, t) {
            ...
            var d = "ok" === e.status;
            ((d && 0 === e.errors) || (d && o)) && (e.update(r(r({}, o && { status: "crashed" }), { errors: e.errors || Number(a || o) })), this.captureSession(e));
          }),
          ...
          (e.prototype._prepareEvent = function (e, t, n) {
            var i = this,
              ...
              c = void 0 === l ? 1e3 : l,
              u = r(r({}, e), { event_id: e.event_id || (n && n.event_id ? n.event_id : be()), timestamp: e.timestamp || qe() });
            ...
            return (
              ...
              d.then(function (e) {
                return e && (e.sdkProcessingMetadata = r(r({}, e.sdkProcessingMetadata), { normalizeDepth: xe(a) + " (" + typeof a + ")" })), "number" == typeof a && a > 0 ? i._normalizeEvent(e, a, c) : e;
              })
            );
          }),
          (e.prototype._normalizeEvent = function (e, t, n) {
                  ...
                  r(
                    ...
                    e.breadcrumbs && {
                      breadcrumbs: e.breadcrumbs.map(function (e) {
                        return r(r({}, e), e.data && { data: xe(e.data, t, n) });
                      }),
                    }
                  ),
            ...
            return e.contexts && e.contexts.trace && (i.contexts.trace = e.contexts.trace), (i.sdkProcessingMetadata = r(r({}, i.sdkProcessingMetadata), { baseClientNormalized: !0 })), i;
          }),
          (e.prototype._applyClientOptions = function (e) {
            ...
            "environment" in e || (e.environment = "environment" in t ? n : "production"),
              ...
              e.message && (e.message = $(e.message, o));
          ...
          (e.prototype._processEvent = function (e, t, n) {
            ...
            return !c && "number" == typeof o && Math.random() > o
              ? (l("sample_rate", "event"), Oe(new x("Discarding event because it's not included in the random sample (sampling rate = " + o + ")")))
              : this._prepareEvent(e, n, t)
                  ...
                  .then(null, function (e) {
                    ...
                    throw (i.captureException(e, { data: { __sentry__: !0 }, originalException: e }), new x("Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.\nReason: " + e));
                  });
          }),
    ...
    function wt(e, t) {
      return t
        ? ((e.sdk = e.sdk || {}),
          ...
          (e.sdk.integrations = a(e.sdk.integrations || [], t.integrations || [])),
    ...
    function _t(e, t) {
      ...
      return [Ue(r(r({ sent_at: new Date().toISOString() }, n && { sdk: n }), !!t.tunnel && { dsn: P(t.dsn) }), [[{ type: i }, e]]), i];
    }
    var kt = (function () {
        function e() {}
        return (
          (e.prototype.sendEvent = function (e) {
            return Pe({ reason: "NoopTransport: Event has been skipped because no Dsn is configured.", status: "skipped" });
          }),
          (e.prototype.close = function (e) {
            return Pe(!0);
          }),
            ...
            if (this._newTransport && this._options.dsn && this._options._experiments && this._options._experiments.newTransport) {
              var t = (function (e, t) {
                ...
                return (
                  ...
                  (e.tags = e.tags || {}),
                  (e.extra = e.extra || {}),
                  (e.sdkProcessingMetadata && e.sdkProcessingMetadata.baseClientNormalized) || ((e.tags.skippedNormalization = !0), (e.extra.normalizeDepth = e.sdkProcessingMetadata ? e.sdkProcessingMetadata.normalizeDepth : "unset")),
                  delete e.sdkProcessingMetadata,
                  Ue(r(r({ event_id: e.event_id, sent_at: new Date().toISOString() }, n && { sdk: n }), !!t.tunnel && { dsn: P(t.dsn) }), [[{ type: i, sample_rates: [{ id: o, rate: a }] }, e]])
                );
      ...
      return {
        send: function (e) {
          var r = (function (e) {
            ...
            s = "event" === r ? "error" : r,
            a = { category: s, body: Be(e) };
          return Ve(i, s)
            ? Oe({ status: "rate_limit", reason: xt(i, s) })
            : n.add(function () {
                return t(a).then(function (e) {
                  var t = e.body,
                    ...
                    r = e.reason,
                    o = Ie(e.statusCode);
                  return n && (i = ze(i, n)), "success" === o ? Pe({ status: o, reason: r }) : Oe({ status: o, reason: r || t || ("rate_limit" === o ? xt(i, s) : "Unknown transport error") });
                });
              });
        },
        flush: function (e) {
                ...
                if (r) {
                  ...
                  return (function (e, t) {
                    if (
                      ...
                      return pt && L.warn("Event dropped due to being internal Sentry Error.\nEvent: " + ke(e)), !0;
                    if (
                      (function (e, t) {
                      ...
                      return pt && L.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + ke(e)), !0;
                    if (
                      (function (e, t) {
                        if (!t || !t.length) return !1;
                        var n = Mt(e);
                      ...
                      return pt && L.warn("Event dropped due to being matched by `denyUrls` option.\nEvent: " + ke(e) + ".\nUrl: " + Mt(e)), !0;
                    if (
                      !(function (e, t) {
                      ...
                      return pt && L.warn("Event dropped due to not being matched by `allowUrls` option.\nEvent: " + ke(e) + ".\nUrl: " + Mt(e)), !0;
                    return !1;
                  })(t, l)
                    ? null
                    : t;
    ...
    function en(e, t, n, i) {
      ...
      if (g(e) || m(e, "DOMException")) {
        ...
        return "code" in o && (s.tags = r(r({}, s.tags), { "DOMException.code": "" + o.code })), s;
      }
      return p(e)
        ? Xt(e)
        : b(e) || w(e)
        ? ((s = (function (e, t, n) {
            var i = {
              exception: { values: [{ type: w(e) ? e.constructor.name : n ? "UnhandledRejection" : "Error", value: "Non-Error " + (n ? "promise rejection" : "exception") + " captured with keys: " + J(e) }] },
          ...
          Ee(s, { synthetic: !0 }),
          s)
        : (Te((s = tn(e, t, n)), "" + e, void 0), Ee(s, { synthetic: !0 }), s);
    }
    function tn(e, t, n) {
      var i = { message: e };
      if (n && t) {
    ...
    var nn,
      rn = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
      sn = u();
    function on() {
      if (nn) return nn;
      ...
      un = (function () {
        function e(e) {
          ...
          (this.options = e),
            ...
            (this._rateLimits = {}),
            (this._outcomes = {}),
            (this._api = at(e.dsn, e._metadata, e.tunnel)),
            (this.url = ht(this._api.dsn)),
            this.options.sendClientReports &&
              cn.document &&
              cn.document.addEventListener("visibilitychange", function () {
        ...
        return (
              ...
              (function (e, t) {
                ...
                try {
                  ...
                  try {
                    ...
                    var u = e;
                    n = JSON.stringify({ message: "JSON.stringify error after renormalization", extra: { message: u.message, stack: u.stack } });
                  }
                }
                var h = { body: n, type: s, url: o ? dt(t.dsn, t.tunnel) : ht(t.dsn) };
                if (o) {
                  var d = Ue(r(r({ event_id: e.event_id, sent_at: new Date().toISOString() }, i && { sdk: i }), !!t.tunnel && { dsn: P(t.dsn) }), [[{ type: s, sample_rates: [{ id: l, rate: c }] }, h.body]]);
                  h.body = Be(d);
                }
                return h;
              })(e, this._api),
            ...
            return this._sendRequest(
              (function (e, t) {
                var n = o(_t(e, t), 2),
                  i = n[0],
                  r = n[1];
                return { body: Be(i), type: r, url: dt(t.dsn, t.tunnel) };
              })(e, this._api),
              e
            );
          }),
            ...
            if (this.options.sendClientReports) {
              ...
              if (((this._outcomes = {}), Object.keys(e).length)) {
                ...
                var t,
                  n,
                  i,
                  r = dt(this._api.dsn, this._api.tunnel),
                  s = Object.keys(e).map(function (t) {
                    var n = o(t.split(":"), 2),
                      i = n[0];
                    return { reason: n[1], category: i, quantity: e[t] };
                  }),
                  a = ((t = s), Ue((n = this._api.tunnel && P(this._api.dsn)) ? { dsn: n } : {}, [[{ type: "client_report" }, { timestamp: i || qe(), discarded_events: t }]]));
                try {
                  an(r, Be(a));
                } catch (e) {
                  rn && L.error(e);
          ...
          (e.prototype._handleResponse = function (e) {
            var t = e.requestType,
              ...
              s = e.reject,
              o = Ie(n.status);
            (this._rateLimits = ze(this._rateLimits, i)), this._isRateLimited(t) && rn && L.warn("Too many " + t + " requests, backing off until: " + this._disabledUntil(t)), "success" !== o ? s(n) : r({ status: o });
          }),
          ...
          (t.prototype._sendRequest = function (e, t) {
            ...
            if (this._isRateLimited(e.type))
              return (
                ...
                Promise.reject({ event: t, type: e.type, reason: "Transport for " + e.type + " requests locked till " + this._disabledUntil(e.type) + " due to too many requests.", status: 429 })
              );
            var i = { body: e.body, method: "POST", referrerPolicy: ie() ? "origin" : "" };
            return (
              void 0 !== this.options.fetchParameters && Object.assign(i, this.options.fetchParameters),
              ...
              this._buffer
                .add(function () {
                  return new Ne(function (t, r) {
                    n._fetch(e.url, i)
                      .then(function (i) {
                        var s = { "x-sentry-rate-limits": i.headers.get("X-Sentry-Rate-Limits"), "retry-after": i.headers.get("Retry-After") };
                        n._handleResponse({ requestType: e.type, response: i, headers: s, resolve: t, reject: r });
                      })
                      .catch(r);
                  });
                })
                  ...
                  .add(function () {
                    return new Ne(function (t, i) {
                      ...
                      for (var s in ((r.onreadystatechange = function () {
                        if (4 === r.readyState) {
                          var s = { "x-sentry-rate-limits": r.getResponseHeader("X-Sentry-Rate-Limits"), "retry-after": r.getResponseHeader("Retry-After") };
                          n._handleResponse({ requestType: e.type, response: r, headers: s, resolve: t, reject: i });
                        }
                      }),
                      r.open("POST", e.url),
                      n.options.headers))
                        Object.prototype.hasOwnProperty.call(n.options.headers, s) && r.setRequestHeader(s, n.options.headers[s]);
                      r.send(e.body);
                    });
                  })
                  .then(void 0, function (t) {
    ...
    var mn = (function (e) {
        ...
        return (
          ...
          (t.prototype._setupTransport = function () {
            ...
            var t,
              n,
              i = r(r({}, this._options.transportOptions), { dsn: this._options.dsn, tunnel: this._options.tunnel, sendClientReports: this._options.sendClientReports, _metadata: this._options._metadata }),
            ...
            if (te()) {
              ...
              return (
                (this._newTransport =
                  ((t = { requestOptions: a, url: o }),
                  void 0 === n && (n = on()),
                  St({ bufferSize: t.bufferSize }, function (e) {
                    var i = r({ body: e.body, method: "POST", referrerPolicy: "origin" }, t.requestOptions);
                    return n(t.url, i).then(function (e) {
                      return e.text().then(function (t) {
                        return { body: t, headers: { "x-sentry-rate-limits": e.headers.get("X-Sentry-Rate-Limits"), "retry-after": e.headers.get("Retry-After") }, reason: e.statusText, statusCode: e.status };
                      });
                    });
                  }))),
                new hn(i)
            ...
            return (
              (this._newTransport = (function (e) {
                return St({ bufferSize: e.bufferSize }, function (t) {
                  return new Ne(function (n, i) {
                    var r = new XMLHttpRequest();
                    for (var s in ((r.onreadystatechange = function () {
                      if (r.readyState === pn) {
                        var e = {
                          body: r.response,
                          headers: { "x-sentry-rate-limits": r.getResponseHeader("X-Sentry-Rate-Limits"), "retry-after": r.getResponseHeader("Retry-After") },
                          reason: r.statusText,
                          statusCode: r.status,
                        };
                        n(e);
                    ...
                    r.open("POST", e.url),
                    e.headers))
                      Object.prototype.hasOwnProperty.call(e.headers, s) && r.setRequestHeader(s, e.headers[s]);
                    r.send(t.body);
                  });
                });
              })({ url: o, headers: i.headers })),
              new dn(i)
            );
          }),
          t
          ...
          throw (
            ...
            (i = function (n) {
              ...
              n.addEventProcessor(function (e) {
                return t.mechanism && (Te(e, void 0, void 0), Ee(e, t.mechanism)), (e.extra = r(r({}, e.extra), { arguments: s })), e;
              }),
                st("captureException", (i = e), { captureContext: o, originalException: i, syntheticException: new Error("Sentry syntheticException") });
            }),
            st("withScope", i),
            e)
          );
    ...
    var wn = (function () {
      function e(t) {
        (this.name = e.id), (this._installFunc = { onerror: _n, onunhandledrejection: kn }), (this._options = r({ onerror: !0, onunhandledrejection: !0 }, t));
      }
      return (
        (e.prototype.setupOnce = function () {
              ...
              void 0 === u && y(s)
                ? (function (e, t, n, i) {
                    var r = /^(?:[Uu]ncaught (?:exception: )?)?(?:((?:Eval|Internal|Range|Reference|Syntax|Type|URI|)Error): )?(.*)$/i,
                      ...
                      a = s.match(r);
                    a && ((o = a[1]), (s = a[2]));
                    var l = { exception: { values: [{ type: o, value: s }] } };
                    return Tn(l, t, n, i);
                  })(s, a, l, c)
                : Tn(en(u || s, void 0, r, !1), a, l, c);
    ...
    function kn() {
      ce("unhandledrejection", function (e) {
        ...
        if (n.getIntegration(wn)) {
          ...
          var a = v(s) ? { exception: { values: [{ type: "UnhandledRejection", value: "Non-Error promise rejection captured with value: " + String(s) }] } } : en(s, void 0, r, !0);
    ...
    function Tn(e, t, n, i) {
      ...
      return 0 === l.length && l.push({ colno: c, filename: d, function: "?", in_app: !0, lineno: h }), e;
    }
    function En(e, t, n, i) {
      Ee(n, { handled: !1, type: i }), e.captureEvent(n, { originalException: t });
    }
    function Sn() {
      var e = tt(),
        t = e.getClient();
    ...
    var xn = [
      ...
      Cn = (function () {
        function e(t) {
          (this.name = e.id), (this._options = r({ XMLHttpRequest: !0, eventTarget: !0, requestAnimationFrame: !0, setInterval: !0, setTimeout: !0 }, t));
        }
        return (
          (e.prototype.setupOnce = function () {
            var e = u();
            this._options.setTimeout && F(e, "setTimeout", An),
              this._options.setInterval && F(e, "setInterval", An),
              this._options.requestAnimationFrame && F(e, "requestAnimationFrame", Pn),
              this._options.XMLHttpRequest && "XMLHttpRequest" in e && F(XMLHttpRequest.prototype, "send", On);
    ...
    function An(e) {
      return function () {
        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        var i = t[0];
        return (t[0] = vn(i, { mechanism: { data: { function: ee(e) }, handled: !0, type: "instrument" } })), e.apply(this, t);
      };
    }
    function Pn(e) {
      return function (t) {
        return e.apply(this, [vn(t, { mechanism: { data: { function: "requestAnimationFrame", handler: ee(e) }, handled: !0, type: "instrument" } })]);
      };
    }
    function On(e) {
      return function () {
        ...
        return (
          ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function (e) {
            e in i &&
              "function" == typeof i[e] &&
              F(i, e, function (t) {
                var n = { mechanism: { data: { function: e, handler: ee(t) }, handled: !0, type: "instrument" } },
                  i = z(t);
    ...
    function Nn(e) {
      ...
      n &&
        ...
        (F(n, "addEventListener", function (t) {
          return function (n, i, r) {
            try {
              "function" == typeof i.handleEvent && (i.handleEvent = vn(i.handleEvent.bind(i), { mechanism: { data: { function: "handleEvent", handler: ee(i), target: e }, handled: !0, type: "instrument" } }));
            } catch (e) {}
            return t.apply(this, [n, vn(i, { mechanism: { data: { function: "addEventListener", handler: ee(i), target: e }, handled: !0, type: "instrument" } }), r]);
          };
        }),
        F(n, "removeEventListener", function (e) {
          return function (t, n, i) {
    ...
    var Ln = (function () {
      function e(t) {
        (this.name = e.id), (this._options = r({ console: !0, dom: !0, fetch: !0, history: !0, sentry: !0, xhr: !0 }, t));
      }
      return (
        (e.prototype.addSentryBreadcrumb = function (e) {
          this._options.sentry && tt().addBreadcrumb({ category: "sentry." + ("transaction" === e.type ? "transaction" : "event"), event_id: e.event_id, level: e.level, message: ke(e) }, { event: e });
        }),
        (e.prototype.setupOnce = function () {
          this._options.console && ce("console", Mn),
            this._options.dom &&
              ce(
                "dom",
                (function (e) {
                  function t(t) {
                    ...
                    0 !== n.length && tt().addBreadcrumb({ category: "ui." + t.name, message: n }, { event: t.event, name: t.name, global: t.global });
                  }
                  return t;
                })(this._options.dom)
              ),
            this._options.xhr && ce("xhr", In),
            this._options.fetch && ce("fetch", jn),
            this._options.history && ce("history", Rn);
        }),
        (e.id = "Breadcrumbs"),
        e
      );
    ...
    function Mn(e) {
      var t = { category: "console", data: { arguments: e.args, logger: "console" }, level: Me(e.level), message: U(e.args, " ") };
      if ("assert" === e.level) {
    ...
    function In(e) {
      if (e.endTimestamp) {
        ...
        var t = e.xhr.__sentry_xhr__ || {},
          ...
          r = t.status_code,
          s = t.body;
        tt().addBreadcrumb({ category: "xhr", data: { method: n, url: i, status_code: r }, type: "http" }, { xhr: e.xhr, input: s });
      } else;
    }
    function jn(e) {
      e.endTimestamp &&
        ((e.fetchData.url.match(/sentry_key/) && "POST" === e.fetchData.method) ||
          (e.error
            ? tt().addBreadcrumb({ category: "fetch", data: e.fetchData, level: i.Error, type: "http" }, { data: e.error, input: e.args })
            : tt().addBreadcrumb({ category: "fetch", data: r(r({}, e.fetchData), { status_code: e.response.status }), type: "http" }, { input: e.args, response: e.response })));
    }
    function Rn(e) {
      var t = u(),
        n = e.from,
        ...
        s = we(n),
        o = we(i);
      s.path || (s = r), r.protocol === o.protocol && r.host === o.host && (i = o.relative), r.protocol === s.protocol && r.host === s.host && (n = s.relative), tt().addBreadcrumb({ category: "navigation", data: { from: n, to: i } });
    }
    var Dn = "cause",
      qn = 5,
      $n = (function () {
            ...
            Ye(function (t) {
              if (tt().getIntegration(e)) {
                ...
                var n = (t.request && t.request.url) || (Bn.location && Bn.location.href),
                  ...
                  o = r(r(r({}, t.request && t.request.headers), i && { Referer: i }), s && { "User-Agent": s }),
                  a = r(r({}, n && { url: n }), { headers: o });
              ...
              if (i) {
                try {
                  if (
                    ...
                    return rn && L.warn("Event dropped due to being a duplicate of previously captured event."), null;
                } catch (e) {
    ...
    var Yn = (function (e) {
        function t(t) {
          void 0 === t && (t = {});
          return (t._metadata = t._metadata || {}), (t._metadata.sdk = t._metadata.sdk || { name: "sentry.javascript.browser", packages: [{ name: "npm:@sentry/browser", version: At }], version: At }), e.call(this, mn, t) || this;
        }
        return (
          n(t, e),
          (t.prototype.showReportDialog = function (e) {
            void 0 === e && (e = {}), u().document && (this._isEnabled() ? bn(r(r({}, e), { dsn: e.dsn || this.getDsn() })) : rn && L.error("Trying to call showReportDialog with Sentry Client disabled"));
          }),
    ...
    var ii = function (e) {
      ...
      di = {
        ...
        count: { className: "shr__count", displayZero: !1, format: !0, position: "after", increment: !0 },
    ...
    var vi = (function () {
      function e(t, n) {
        ...
        Qn(this, e),
          ...
          ui.element(t) ? (this.elements.trigger = t) : ui.string(t) && (this.elements.trigger = document.querySelector(t)),
          ui.element(this.elements.trigger) &&
            ui.empty(this.elements.trigger.shr) &&
            ((this.config = gi({}, di, n, { networks: hi })),
            (this.console = new mi(this.config.debug)),
            (this.storage = new yi(this.config.storage.key, this.config.storage.ttl, this.config.storage.enabled)),
            this.getCount()
              .then(function (e) {
              ...
              value: function (e) {
                if (!ui.empty(this.network) && this.networkConfig.popup) {
                  ...
                  if (this.popup && !this.popup.closed) this.popup.focus(), this.console.log("Popup re-focused.");
                    ...
                    (this.popup = window.open(this.href, r, "top=".concat(l, ",left=").concat(a, ",width=").concat(n, ",height=").concat(i))),
                      this.popup && !this.popup.closed && ui.boolean(this.popup.closed) ? (this.popup.focus(), this.console.log("Popup opened.")) : this.console.error("Popup blocked.");
                  }
                }
              },
            },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (0 < s || i.displayZero) {
                  ...
                  i.format && (1e6 < s ? (l = "".concat(a(1e6), "M")) : 1e3 < s && (l = "".concat(a(1e3), "K"))),
                    ui.element(this.elements.count)
                      ...
                      : ((function (e, t) {
                        ...
                        })(this.elements.trigger, fi("span", { class: r.className })),
                        (this.elements.count = fi("span", { class: "".concat(i.className, " ").concat(i.className, "--").concat(o) }, l)),
                        this.elements.trigger.insertAdjacentElement("after" === o ? "afterend" : "beforebegin", this.elements.count));
                }
              },
            },
            {
    ...
    var Ei = { addCSS: !0, thumbWidth: 15, watch: !0 };
    var Si = function (e) {
        return null != e ? e.constructor : null;
      },
      xi = function (e, t) {
    ...
    var Ii = (function () {
      function e(t, n) {
        (function (e, t) {
          ...
          Li.element(t) ? (this.element = t) : Li.string(t) && (this.element = document.querySelector(t)),
          Li.element(this.element) && Li.empty(this.element.rangeTouch) && ((this.config = Ti({}, Ei, {}, n)), this.init());
      }
      return (
        (function (e, t, n) {
          ...
          [
            {
              ...
              value: function () {
                e.enabled &&
                  (this.config.addCSS && ((this.element.style.userSelect = "none"), (this.element.style.webKitUserSelect = "none"), (this.element.style.touchAction = "manipulation")), this.listeners(!0), (this.element.rangeTouch = this));
              },
            },
            {
              key: "destroy",
          ...
          [
            {
              ...
              value: function (t) {
                var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                  i = null;
                if (
                  (Li.empty(t) || Li.string(t)
                    ? (i = Array.from(document.querySelectorAll(Li.string(t) ? t : 'input[type="range"]')))
                    : Li.element(t)
                    ? (i = [t])
                    : Li.nodeList(t)
                    ? (i = Array.from(t))
                    : Li.array(t) && (i = t.filter(Li.element)),
                  Li.empty(i))
                )
                  return null;
                var r = Ti({}, Ei, {}, n);
    ...
    function Ji(e = {}, ...t) {
      ...
      return Vi.object(n)
        ? (Object.keys(n).forEach((t) => {
            Vi.object(n[t]) ? (Object.keys(e).includes(t) || Object.assign(e, { [t]: {} }), Ji(e[t], n[t])) : Object.assign(e, { [t]: n[t] });
          }),
          Ji(e, ...t))
        : e;
    }
    ...
    function ur(e = null, t = !1) {
      Vi.element(e) && e.focus({ preventScroll: !0, focusVisible: t });
    }
    const hr = { "audio/ogg": "vorbis", "audio/wav": "1", "video/webm": "vp8, vorbis", "video/mp4": "avc1.42E01E, mp4a.40.2", "video/ogg": "theora" },
      dr = {
        audio: "canPlayType" in document.createElement("audio"),
        video: "canPlayType" in document.createElement("video"),
        check(e, t) {
          const n = dr[e] || "html5" !== t;
          return { api: n, ui: n && dr.rangeInput };
        },
    ...
    function mr(e, t, n, i = !1, r = !0, s = !1) {
      ...
      const o = t.split(" ");
      let a = s;
      pr && (a = { passive: r, capture: s }),
        o.forEach((t) => {
          this && this.eventListeners && i && this.eventListeners.push({ element: e, type: t, callback: n, options: a }), e[i ? "addEventListener" : "removeEventListener"](t, n, a);
        });
    }
    ...
    function vr(e, t = "", n = !1, i = {}) {
      ...
      const r = new CustomEvent(t, { bubbles: n, detail: { ...i, plyr: this } });
      e.dispatchEvent(r);
    }
    function br() {
      this &&
    ...
    function Ar(e) {
      ...
      let n = t(e);
      if ((null === n && (n = t(this.config.ratio)), null === n && !Vi.empty(this.embed) && Vi.array(this.embed.ratio) && ({ ratio: n } = this.embed), null === n && this.isHTML5)) {
    ...
    const Nr = {
      ...
      setup() {
        ...
        (e.options.speed = e.config.speed.options),
          Vi.empty(this.config.ratio) || Pr.call(e),
            ...
            set(t) {
              if (e.quality !== t) {
                if (e.config.quality.forced && Vi.function(e.config.quality.onChange)) e.config.quality.onChange(t);
                  ...
                  if (!n) return;
                  const { currentTime: i, paused: r, preload: s, readyState: o, playbackRate: a } = e.media;
                ...
                vr.call(e, e.media, "qualitychange", !1, { quality: t });
              }
            },
          });
      },
    ...
    const Dr = { pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube" },
      qr = {
        get(e = "", t = {}) {
        ...
        Ur(e)
          .then((e) => {
            if (!Vi.empty(e)) {
              if (s)
                try {
                  window.localStorage.setItem(`${n}-${t}`, JSON.stringify({ content: e }));
                } catch (e) {}
              o(a, e);
            }
          })
    ...
    const Wr = {
      ...
      findElements() {
        try {
          return (
            (this.elements.controls = cr.call(this, this.config.selectors.controls.wrapper)),
            ...
            (this.elements.progress = cr.call(this, this.config.selectors.progress)),
            (this.elements.inputs = { seek: cr.call(this, this.config.selectors.inputs.seek), volume: cr.call(this, this.config.selectors.inputs.volume) }),
            ...
            Vi.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(`.${this.config.classNames.tooltip}`)),
            !0
          );
        } catch (e) {
      ...
      createIcon(e, t) {
        ...
        Gi(s, Ji(t, { "aria-hidden": "true", focusable: "false" }));
      ...
      createLabel(e, t = {}) {
        ...
        return Qi("span", { ...t, class: [t.class, this.config.classNames.hidden].filter(Boolean).join(" ") }, n);
      },
      createBadge(e) {
        if (Vi.empty(e)) return null;
        const t = Qi("span", { class: this.config.classNames.menu.value });
        return t.appendChild(Qi("span", { class: this.config.classNames.menu.badge }, e)), t;
      },
      createButton(e, t) {
        const n = Ji({}, t);
        let i = jr(e);
        const r = { element: "button", toggle: !1, label: null, icon: null, labelPressed: null, iconPressed: null };
        switch (
          (["element", "icon", "label"].forEach((e) => {
            Object.keys(n).includes(e) && ((r[e] = n[e]), delete n[e]);
          }),
          "button" !== r.element || Object.keys(n).includes("type") || (n.type = "button"),
          Object.keys(n).includes("class") ? n.class.split(" ").some((e) => e === this.config.classNames.control) || Ji(n, { class: `${n.class} ${this.config.classNames.control}` }) : (n.class = this.config.classNames.control),
          e)
        ) {
          case "play":
        ...
        return (
          r.toggle
            ? (s.appendChild(Wr.createIcon.call(this, r.iconPressed, { class: "icon--pressed" })),
              s.appendChild(Wr.createIcon.call(this, r.icon, { class: "icon--not-pressed" })),
              s.appendChild(Wr.createLabel.call(this, r.labelPressed, { class: "label--pressed" })),
              s.appendChild(Wr.createLabel.call(this, r.label, { class: "label--not-pressed" })))
            : (s.appendChild(Wr.createIcon.call(this, r.icon)), s.appendChild(Wr.createLabel.call(this, r.label))),
          Ji(n, ir(this.config.selectors.buttons[i], n)),
          Gi(s, n),
          "play" === i ? (Vi.array(this.elements.buttons[i]) || (this.elements.buttons[i] = []), this.elements.buttons[i].push(s)) : (this.elements.buttons[i] = s),
          s
        );
      },
      createRange(e, t) {
        const n = Qi(
          "input",
          Ji(
            ir(this.config.selectors.inputs[e]),
            { type: "range", min: 0, max: 100, step: 0.01, value: 0, autocomplete: "off", role: "slider", "aria-label": qr.get(e, this.config), "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": 0 },
            t
          )
        );
      ...
      createProgress(e, t) {
        const n = Qi("progress", Ji(ir(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: "progressbar", "aria-hidden": !0 }, t));
        if ("volume" !== e) {
      ...
      createTime(e, t) {
        const n = ir(this.config.selectors.display[e], t),
          i = Qi("div", Ji(n, { class: `${n.class ? n.class : ""} ${this.config.classNames.display.time} `.trim(), "aria-label": qr.get(e, this.config), role: "timer" }), "00:00");
            ...
            if (!i && [" ", "ArrowRight"].includes(n.key)) Wr.showMenuPanel.call(this, t, !0);
              ...
              " " !== n.key &&
                ("ArrowDown" === n.key || (i && "ArrowRight" === n.key)
                  ? ((t = e.nextElementSibling), Vi.element(t) || (t = e.parentNode.firstElementChild))
                  : ((t = e.previousElementSibling), Vi.element(t) || (t = e.parentNode.lastElementChild)),
                ur.call(this, t, !0));
            }
          },
          !1
        ),
          fr.call(this, e, "keyup", (e) => {
            "Return" === e.key && Wr.focusFirstMenuItem.call(this, null, !0);
          });
      },
      createMenuItem({ value: e, list: t, type: n, title: i, badge: r = null, checked: s = !1 }) {
        const o = ir(this.config.selectors.inputs[n]),
          a = Qi("button", Ji(o, { type: "button", role: "menuitemradio", class: `${this.config.classNames.control} ${o.class ? o.class : ""}`.trim(), "aria-checked": s, value: e })),
          l = Qi("span");
        (l.innerHTML = i),
          Vi.element(r) && l.appendChild(r),
          a.appendChild(l),
            ...
            set(e) {
              e &&
                Array.from(a.parentNode.children)
                  .filter((e) => ar(e, '[role="menuitemradio"]'))
          ...
          Wr.bindMenuItemShortcuts.call(this, a, n),
          t.appendChild(a);
      },
      formatTime(e = 0, t = !1) {
      ...
      updateVolume() {
        this.supported.ui &&
          (Vi.element(this.elements.inputs.volume) && Wr.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
          Vi.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume));
      },
      setRange(e, t = 0) {
      ...
      updateSeekTooltip(e) {
        ...
        const c = null === (t = this.config.markers) || void 0 === t || null === (n = t.points) || void 0 === n ? void 0 : n.find(({ time: e }) => e === Math.round(l));
      ...
      durationUpdate() {
        ...
        !e && this.config.displayDuration && this.paused && Wr.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
          e && Wr.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
          this.config.markers.enabled && Wr.setMarkers.call(this),
          Wr.updateSeekTooltip.call(this);
      },
      ...
      setQualityMenu(e) {
        ...
        this.options.quality
          ...
          .forEach((e) => {
            Wr.createMenuItem.call(this, { value: e, list: n, type: t, title: Wr.getLabel.call(this, "quality", e), badge: r(e) });
          }),
      ...
      setCaptionsMenu() {
        ...
        r.unshift({ value: -1, checked: !this.captions.toggled, title: qr.get("disabled", this.config), list: t, type: "language" }), r.forEach(Wr.createMenuItem.bind(this)), Wr.updateSetting.call(this, e, t);
      },
      setSpeedMenu() {
        ...
        Wr.toggleMenuButton.call(this, e, n),
          tr(t),
          Wr.checkMenu.call(this),
          n &&
            (this.options.speed.forEach((n) => {
              Wr.createMenuItem.call(this, { value: n, list: t, type: e, title: Wr.getLabel.call(this, "speed", n) });
            }),
            Wr.updateSetting.call(this, e, t));
      },
      checkMenu() {
        const { buttons: e } = this.elements.settings,
          t = !Vi.empty(e) && Object.values(e).some((e) => !e.hidden);
      ...
      toggleMenu(e) {
        ...
        n.setAttribute("aria-expanded", r),
          rr(t, !r),
          sr(this.elements.container, this.config.classNames.menu.open, r),
          r && Vi.keyboardEvent(e) ? Wr.focusFirstMenuItem.call(this, null, !0) : r || i || ur.call(this, n, Vi.keyboardEvent(e));
      },
      getMenuSize(e) {
      ...
      create(e) {
        const { bindMenuItemShortcuts: t, createButton: n, createProgress: i, createRange: r, createTime: s, setQualityMenu: o, setSpeedMenu: a, showMenuPanel: l } = Wr;
        ...
        return (
          kr(Vi.array(this.config.controls) ? this.config.controls : []).forEach((o) => {
            if (
              ...
              "fast-forward" === o && c.appendChild(n.call(this, "fast-forward", u)),
              "progress" === o)
            ) {
              const t = Qi("div", { class: `${u.class} plyr__progress__container` }),
                n = Qi("div", ir(this.config.selectors.progress));
              if ((n.appendChild(r.call(this, "seek", { id: `plyr-seek-${e.id}` })), n.appendChild(i.call(this, "buffer")), this.config.tooltips.seek)) {
                const e = Qi("span", { class: this.config.classNames.tooltip }, "00:00");
            ...
            if (("current-time" === o && c.appendChild(s.call(this, "currentTime", u)), "duration" === o && c.appendChild(s.call(this, "duration", u)), "mute" === o || "volume" === o)) {
              ...
              if (
                ((Vi.element(t) && c.contains(t)) || ((t = Qi("div", Ji({}, u, { class: `${u.class} plyr__volume`.trim() }))), (this.elements.volume = t), c.appendChild(t)),
                "mute" === o && t.appendChild(n.call(this, "mute")),
                "volume" === o && !Ki.isIos && !Ki.isIPadOS)
              ) {
                const n = { max: 1, step: 0.05, value: this.config.volume };
                t.appendChild(r.call(this, "volume", Ji(n, { id: `plyr-volume-${e.id}` })));
              }
            }
            if (("captions" === o && c.appendChild(n.call(this, "captions", u)), "settings" === o && !Vi.empty(this.config.settings))) {
              const i = Qi("div", Ji({}, u, { class: `${u.class} plyr__menu`.trim(), hidden: "" }));
              i.appendChild(n.call(this, "settings", { "aria-haspopup": !0, "aria-controls": `plyr-settings-${e.id}`, "aria-expanded": !1 }));
              const r = Qi("div", { class: "plyr__menu__container", id: `plyr-settings-${e.id}`, hidden: "" }),
                s = Qi("div"),
                o = Qi("div", { id: `plyr-settings-${e.id}-home` }),
                a = Qi("div", { role: "menu" });
              o.appendChild(a),
                s.appendChild(o),
                ...
                this.config.settings.forEach((n) => {
                  const i = Qi(
                    "button",
                    Ji(ir(this.config.selectors.buttons.settings), {
                      type: "button",
                  ...
                  t.call(this, i, n),
                    fr.call(this, i, "click", () => {
                      l.call(this, n, !1);
                    });
                  const r = Qi("span", null, qr.get(n, this.config)),
                    o = Qi("span", { class: this.config.classNames.menu.value });
                  (o.innerHTML = e[n]), r.appendChild(o), i.appendChild(r), a.appendChild(i);
                  const c = Qi("div", { id: `plyr-settings-${e.id}-${n}`, hidden: "" }),
                    u = Qi("button", { type: "button", class: `${this.config.classNames.control} ${this.config.classNames.control}--back` });
                  u.appendChild(Qi("span", { "aria-hidden": !0 }, qr.get(n, this.config))),
                    u.appendChild(Qi("span", { class: this.config.classNames.hidden }, qr.get("menuBack", this.config))),
                    fr.call(
                      this,
                      c,
                      "keydown",
                    ...
                    fr.call(this, u, "click", () => {
                      l.call(this, "home", !1);
                    }),
                    c.appendChild(u),
                    c.appendChild(Qi("div", { role: "menu" })),
                    s.appendChild(c),
            ...
            if (("pip" === o && dr.pip && c.appendChild(n.call(this, "pip", u)), "airplay" === o && dr.airplay && c.appendChild(n.call(this, "airplay", u)), "download" === o)) {
              const e = Ji({}, u, { element: "a", href: this.download, target: "_blank" });
              this.isHTML5 && (e.download = "");
              const { download: t } = this.config.urls;
              !Vi.url(t) && this.isEmbed && Ji(e, { icon: `logo-${this.provider}`, label: this.provider }), c.appendChild(n.call(this, "download", e));
            }
            "fullscreen" === o && c.appendChild(n.call(this, "fullscreen", u));
          }),
          this.isHTML5 && o.call(this, Nr.getQualityOptions.call(this)),
          a.call(this),
          c
        );
      },
      inject() {
        ...
        let n = !0;
        Vi.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
          this.config.controls || (this.config.controls = []),
          Vi.element(this.config.controls) || Vi.string(this.config.controls)
            ? (e = this.config.controls)
            : ((e = Wr.create.call(this, { id: this.id, seektime: this.config.seekTime, speed: this.speed, quality: this.quality, captions: Jr.getLabel.call(this) })), (n = !1));
        let i;
        n &&
          Vi.string(this.config.controls) &&
          (e = ((e) => {
            let n = e;
            return (
          ...
          Vi.string(this.config.selectors.controls.container) && (i = document.querySelector(this.config.selectors.controls.container)),
          Vi.element(i) || (i = this.elements.container);
      ...
      setMarkers() {
        ...
        const n = null === (e = this.config.markers) || void 0 === e || null === (t = e.points) || void 0 === t ? void 0 : t.filter(({ time: e }) => e > 0 && e < this.duration);
        ...
        const o = `${this.config.classNames.tooltip}--visible`,
          a = (e) => sr(s, o, e);
        n.forEach((e) => {
          const t = Qi("span", { class: this.config.classNames.marker }, ""),
          ...
          i.appendChild(r),
          this.config.tooltips.seek || ((s = Qi("span", { class: this.config.classNames.tooltip }, "")), i.appendChild(s)),
    ...
    const Jr = {
        setup() {
          ...
          if (!this.isVideo || this.isYouTube || (this.isHTML5 && !dr.textTracks))
            return void (Vi.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Wr.setCaptionsMenu.call(this));
          var e, t;
          if (
            (Vi.element(this.elements.captions) ||
              ((this.elements.captions = Qi("div", ir(this.config.selectors.captions))),
              this.elements.captions.setAttribute("dir", "auto"),
              (e = this.elements.captions),
              (t = this.elements.wrapper),
              Vi.element(e) && Vi.element(t) && t.parentNode.insertBefore(e, t.nextSibling)),
            Ki.isIE && window.URL)
          ) {
          ...
          if ((Vi.boolean(r) || ({ active: r } = this.config.captions), Object.assign(this.captions, { toggled: !1, active: r, language: i, languages: n }), this.isHTML5)) {
        ...
        update() {
          const e = Jr.getTracks.call(this, !0),
            { active: t, language: n, meta: i, currentTrackNode: r } = this.captions,
          ...
          this.isHTML5 &&
            ...
            e
              .filter((e) => !i.get(e))
              .forEach((e) => {
                this.debug.log("Track added", e), i.set(e, { default: "showing" === e.mode }), "showing" === e.mode && (e.mode = "hidden"), fr.call(this, e, "cuechange", () => Jr.updateCues.call(this));
              }),
            ((s && this.language !== n) || !e.includes(r)) && (Jr.setLanguage.call(this, n), Jr.toggle.call(this, t && s)),
            this.elements && sr(this.elements.container, this.config.classNames.captions.enabled, !Vi.empty(e)),
            Vi.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Wr.setCaptionsMenu.call(this);
        },
        toggle(e, t = !0) {
          if (!this.supported.ui) return;
          const { toggled: n } = this.captions,
            i = this.config.classNames.captions.active,
            r = Vi.nullOrUndefined(e) ? !n : e;
          if (r !== n) {
            ...
            this.elements.buttons.captions && (this.elements.buttons.captions.pressed = r),
              sr(this.elements.container, i, r),
              (this.captions.toggled = r),
              Wr.updateSetting.call(this, "captions"),
              vr.call(this, this.media, r ? "captionsenabled" : "captionsdisabled");
          }
          setTimeout(() => {
              ...
              if (e in n) {
                if (this.captions.currentTrack !== e) {
                  ...
                  (this.captions.currentTrackNode = i),
                    ...
                    vr.call(this, this.media, "languagechange");
                }
        ...
        getLabel(e) {
          let t = e;
          return (
            !Vi.track(t) && dr.textTracks && this.captions.toggled && (t = Jr.getCurrentTrack.call(this)),
            Vi.track(t) ? (Vi.empty(t.label) ? (Vi.empty(t.language) ? qr.get("enabled", this.config) : e.language.toUpperCase()) : t.label) : qr.get("disabled", this.config)
          );
        },
        updateCues(e) {
          if (!this.supported.ui) return;
      ...
      Xr = {
        ...
        urls: {
          ...
          youtube: { sdk: "https://www.youtube.com/iframe_api", api: "https://www.youtube-nocookie.com/oembed/?url=https://www.youtube-nocookie.com/watch?v={0}" },
      ...
      Qr = "inline",
      Zr = { html5: "html5", youtube: "youtube", vimeo: "vimeo" },
      es = "audio",
      ts = "video";
    const ns = () => {};
    class is {
    ...
    class rs {
        ...
        bi(this, "onChange", () => {
          ...
          bi(this, "toggleFallback", (e = !1) => {
            if (
              ...
              sr(this.target, this.player.config.classNames.fullscreen.fallback, e),
              Ki.isIos)
            ) {
          ...
          bi(this, "enter", () => {
            this.supported &&
              (Ki.isIos && this.player.config.fullscreen.iosNative
                ? this.player.isVimeo
                  ? this.player.embed.requestFullscreen()
                  : this.target.webkitEnterFullscreen()
                : !rs.nativeSupported || this.forceFallback
                ? this.toggleFallback(!0)
                : this.prefix
                ? Vi.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]()
          ...
          fr.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : `${this.prefix}fullscreenchange`, () => {
            this.onChange();
          }),
          ...
          fr.call(this, this.player.elements.container, "keydown", (e) => this.trapFocus(e)),
          this.update();
      }
      ...
      get supported() {
        return [
          ...
          this.player.isVideo,
          rs.nativeSupported || this.player.config.fullscreen.fallback,
          !this.player.isYouTube || rs.nativeSupported || !Ki.isIos || (this.player.config.playsinline && !this.player.config.fullscreen.iosNative),
        ].every(Boolean);
      }
      get active() {
    ...
    const os = {
      ...
      build() {
        ...
        Vi.element(this.elements.controls) || (Wr.inject.call(this), this.listeners.controls()),
          os.toggleNativeControls.call(this),
          this.isHTML5 && Jr.setup.call(this),
          (this.volume = null),
          (this.muted = null),
          (this.loop = null),
          (this.quality = null),
          (this.speed = null),
          Wr.updateVolume.call(this),
          Wr.timeUpdate.call(this),
          Wr.durationUpdate.call(this),
          os.checkPlaying.call(this),
          sr(this.elements.container, this.config.classNames.pip.supported, dr.pip && this.isHTML5 && this.isVideo),
          sr(this.elements.container, this.config.classNames.airplay.supported, dr.airplay && this.isHTML5),
          sr(this.elements.container, this.config.classNames.isTouch, this.touch),
          (this.ready = !0),
          setTimeout(() => {
            vr.call(this, this.media, "ready");
          }, 0),
          os.setTitle.call(this),
          this.poster && os.setPoster.call(this, this.poster, !1).catch(() => {}),
          this.config.duration && Wr.durationUpdate.call(this),
          this.config.mediaMetadata && Wr.setMediaMetadata.call(this);
      },
      setTitle() {
        let e = qr.get("play", this.config);
        if (
          (Vi.string(this.config.title) && !Vi.empty(this.config.title) && (e += `, ${this.config.title}`),
        ...
        return t && this.poster
          ...
          : (this.media.setAttribute("data-poster", e),
            ...
            wr
              ...
              .then(() => (Object.assign(this.elements.poster.style, { backgroundImage: `url('${e}')`, backgroundSize: "" }), os.togglePoster.call(this, !0), e)));
      },
      checkPlaying(e) {
        sr(this.elements.container, this.config.classNames.playing, this.playing),
          sr(this.elements.container, this.config.classNames.paused, this.paused),
          sr(this.elements.container, this.config.classNames.stopped, this.stopped),
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            Object.assign(e, { pressed: this.playing }), e.setAttribute("aria-label", qr.get(this.playing ? "pause" : "play", this.config));
          }),
      ...
      migrateStyles() {
        Object.values({ ...this.media.style })
          .filter((e) => !Vi.empty(e) && Vi.string(e) && e.startsWith("--plyr"))
          .forEach((e) => {
    ...
    class as {
      constructor(e) {
        bi(this, "firstTouch", () => {
          ...
          bi(this, "container", () => {
            ...
            !t.keyboard.global && t.keyboard.focused && fr.call(e, n.container, "keydown keyup", this.handleKey, !1),
              fr.call(e, n.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t) => {
                const { controls: r } = n;
          ...
          bi(this, "media", () => {
            const { player: e } = this,
              { elements: t } = e;
            if (
              (fr.call(e, e.media, "timeupdate seeking seeked", (t) => Wr.timeUpdate.call(e, t)),
              fr.call(e, e.media, "durationchange loadeddata loadedmetadata", (t) => Wr.durationUpdate.call(e, t)),
              fr.call(e, e.media, "ended", () => {
                e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause());
              }),
              fr.call(e, e.media, "progress playing seeking seeked", (t) => Wr.updateProgress.call(e, t)),
              fr.call(e, e.media, "volumechange", (t) => Wr.updateVolume.call(e, t)),
              fr.call(e, e.media, "playing play pause ended emptied timeupdate", (t) => os.checkPlaying.call(e, t)),
              fr.call(e, e.media, "waiting canplay seeked playing", (t) => os.checkLoading.call(e, t)),
            ...
            e.supported.ui &&
              ...
              fr.call(e, e.media, "volumechange", () => {
                e.storage.set({ volume: e.volume, muted: e.muted });
              }),
              fr.call(e, e.media, "ratechange", () => {
                Wr.updateSetting.call(e, "speed"), e.storage.set({ speed: e.speed });
              }),
          ...
          bi(this, "controls", () => {
            ...
            this.bind(
              ...
              this.bind(t.progress, "mouseenter mouseleave mousemove", (t) => Wr.updateSeekTooltip.call(e, t)),
              ...
              Ki.isWebKit &&
                Array.from(lr.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, "input", (t) => Wr.updateRangeFill.call(e, t.target));
                }),
              e.config.toggleInvert &&
                !Vi.element(t.display.duration) &&
              ...
              this.bind(t.controls, "focusin", () => {
                ...
                sr(t.controls, n.classNames.noTransition, !0),
                  os.toggleControls.call(e, !0),
                  setTimeout(() => {
      ...
      handleKey(e) {
        const { player: t } = this,
          { elements: n } = t,
          { key: i, type: r, altKey: s, ctrlKey: o, metaKey: a, shiftKey: l } = e,
          c = "keydown" === r,
          u = c && i === this.lastKey;
        if (s || o || a || l) return;
        if (!i) return;
    ...
    const hs = {
      setup() {
        const e = this;
        sr(e.elements.wrapper, e.config.classNames.embed, !0),
          (e.options.speed = e.config.speed.options),
          Pr.call(e),
          Vi.object(window.Vimeo)
            ? hs.ready.call(e)
            : cs(e.config.urls.vimeo.sdk)
                .then(() => {
                  hs.ready.call(e);
                })
                .catch((t) => {
      ...
      ready() {
        ...
        let s = e.media.getAttribute("src"),
          o = "";
        Vi.empty(s)
          ? ((s = e.media.getAttribute(e.config.attributes.embed.id)), (o = e.media.getAttribute(e.config.attributes.embed.hash)))
          : (o = (function (e) {
        ...
        const l = Yr({ loop: e.config.loop.active, autoplay: e.autoplay, muted: e.muted, gesture: "media", playsinline: e.config.playsinline, ...a, ...r }),
        ...
        if (
          ...
          Vi.empty(i) || h.setAttribute("referrerPolicy", i),
          n || !t.customControls)
        )
          h.setAttribute("data-poster", e.poster), (e.media = nr(h, e.media));
        else {
          const t = Qi("div", { class: e.config.classNames.embedContainer, "data-poster": e.poster });
          t.appendChild(h), (e.media = nr(t, e.media));
        }
        t.customControls ||
          Ur(Lr(e.config.urls.vimeo.api, d)).then((t) => {
          ...
          (e.media.play = () => (us.call(e, !0), e.embed.play())),
          (e.media.pause = () => (us.call(e, !1), e.embed.pause())),
          (e.media.stop = () => {
        ...
        Object.defineProperty(e.media, "loop", {
          ...
          e.embed.on("progress", (t) => {
            (e.media.buffered = t.percent),
              vr.call(e, e.media, "progress"),
              1 === parseInt(t.percent, 10) && vr.call(e, e.media, "canplaythrough"),
              e.embed.getDuration().then((t) => {
    ...
    const ms = {
        ...
        getTitle(e) {
          Ur(Lr(this.config.urls.youtube.api, e))
            .then((e) => {
              if (Vi.object(e)) {
        ...
        ready() {
          ...
          var s;
          const o = Qi("div", { id: `${e.provider}-${Math.floor(1e4 * Math.random())}`, "data-poster": t.customControls ? e.poster : void 0 });
          if (((e.media = nr(o, e.media)), t.customControls)) {
            const t = (e) => `https://i.ytimg.com/vi/${r}/${e}default.jpg`;
            ss(t("maxres"), 121)
              .catch(() => ss(t("sd"), 121))
              .catch(() => ss(t("hq")))
              .then((t) => os.setPoster.call(e, t.src))
              .then((t) => {
            ...
            events: {
              onError(t) {
                if (!e.media.error) {
                  ...
                  (e.media.error = { code: n, message: i }), vr.call(e, e.media, "error");
                }
              },
              ...
              onReady(n) {
                ...
                Object.defineProperty(e.media, "muted", {
                  ...
                  Object.defineProperty(e.media, "currentSrc", { get: () => i.getVideoUrl() }),
                  Object.defineProperty(e.media, "ended", { get: () => e.currentTime === e.duration });
                ...
                (e.options.speed = a.filter((t) => e.config.speed.options.includes(t))),
                  ...
                  vr.call(e, e.media, "durationchange"),
                  clearInterval(e.timers.buffering),
                  (e.timers.buffering = setInterval(() => {
                    (e.media.buffered = i.getVideoLoadedFraction()),
                      (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && vr.call(e, e.media, "progress"),
                      (e.media.lastBuffered = e.media.buffered),
                      1 === e.media.buffered && (clearInterval(e.timers.buffering), vr.call(e, e.media, "canplaythrough"));
                  }, 200)),
                  t.customControls && setTimeout(() => os.build.call(e), 50);
              },
              onStateChange(n) {
                const i = n.target;
                  ...
                  case 1:
                    t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed
                      ...
                      : (ds.call(e, !0),
                        ...
                        e.media.duration !== i.getDuration() && ((e.media.duration = i.getDuration()), vr.call(e, e.media, "durationchange")));
                    break;
                  case 2:
                ...
                vr.call(e, e.elements.container, "statechange", !1, { code: n.data });
              },
            },
          });
        },
      ...
      fs = {
        setup() {
          this.media
            ? (sr(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
              sr(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
              this.isEmbed && sr(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
              this.isVideo &&
                ((this.elements.wrapper = Qi("div", { class: this.config.classNames.video })),
                Xi(this.media, this.elements.wrapper),
                (this.elements.poster = Qi("div", { class: this.config.classNames.poster })),
                this.elements.wrapper.appendChild(this.elements.poster)),
              this.isHTML5 ? Nr.setup.call(this) : this.isYouTube ? ms.setup.call(this) : this.isVimeo && hs.setup.call(this))
    ...
    class gs {
      constructor(e) {
        bi(this, "load", () => {
          this.enabled &&
            (Vi.object(window.google) && Vi.object(window.google.ima)
              ? this.ready()
              : cs(this.player.config.urls.googleIMA.sdk)
                  .then(() => {
                    this.ready();
                  })
                  .catch(() => {
          ...
          bi(this, "setupIMA", () => {
            (this.elements.container = Qi("div", { class: this.player.config.classNames.ads })),
          ...
          bi(this, "addCuePoints", () => {
            Vi.empty(this.cuePoints) ||
              this.cuePoints.forEach((e) => {
                if (0 !== e && -1 !== e && e < this.player.duration) {
                  const t = this.player.elements.progress;
                  if (Vi.element(t)) {
                    const n = (100 / this.player.duration) * e,
                      i = Qi("span", { class: this.player.config.classNames.cues });
          ...
          bi(this, "on", (e, t) => (Vi.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)),
      ...
      get tagUrl() {
        ...
        return `https://go.aniview.com/api/adserver6/vast/?${Yr({
    ...
    class ws {
        ...
        bi(this, "load", () => {
          ...
          bi(
            ...
            (e) =>
              new Promise((t) => {
                Ur(e).then((n) => {
                  const i = { frames: vs(n), height: null, urlPrefix: "" };
            ...
            if (this.loaded && Vi.event(e) && ["touchmove", "mousemove"].includes(e.type) && this.player.media.duration) {
              if ("touchmove" === e.type) this.seekTime = this.player.media.duration * (this.player.elements.inputs.seek.value / 100);
                ...
                (this.seekTime = this.player.media.duration * (r / 100)),
                  ...
                  (this.elements.thumb.time.innerText = zr(this.seekTime));
                const s = null === (t = this.player.config.markers) || void 0 === t || null === (n = t.points) || void 0 === n ? void 0 : n.find(({ time: e }) => e === Math.round(this.seekTime));
          ...
          bi(this, "endScrubbing", () => {
            (this.mouseDown = !1),
              Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime)
                ...
                : yr.call(this.player, this.player.media, "timeupdate", () => {
          ...
          bi(this, "render", () => {
            (this.elements.thumb.container = Qi("div", { class: this.player.config.classNames.previewThumbnails.thumbContainer })),
              (this.elements.thumb.imageContainer = Qi("div", { class: this.player.config.classNames.previewThumbnails.imageContainer })),
              this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
            const e = Qi("div", { class: this.player.config.classNames.previewThumbnails.timeContainer });
            (this.elements.thumb.time = Qi("span", {}, "00:00")),
              e.appendChild(this.elements.thumb.time),
              this.elements.thumb.imageContainer.appendChild(e),
              Vi.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container),
              (this.elements.scrubbing.container = Qi("div", { class: this.player.config.classNames.previewThumbnails.scrubbingContainer })),
          ...
          bi(this, "loadImage", (e = 0) => {
            ...
            if (this.currentImageElement && this.currentImageElement.dataset.filename === s)
              this.showImage(this.currentImageElement, r, e, t, s, !1), (this.currentImageElement.dataset.index = t), this.removeOldImages(this.currentImageElement);
            else {
          ...
          bi(this, "showImage", (e, t, n, i, r, s = !0) => {
            this.player.debug.log(`Showing thumb: ${r}. num: ${i}. qual: ${n}. newimg: ${s}`),
              this.setImageSizeAndOffset(e, t),
              s && (this.currentImageContainer.appendChild(e), (this.currentImageElement = e), this.loadedImages.includes(r) || this.loadedImages.push(r)),
          ...
          bi(this, "setScrubbingContainerSize", () => {
            const { width: e, height: t } = bs(this.thumbAspectRatio, { width: this.player.media.clientWidth, height: this.player.media.clientHeight });
      ...
      get thumbContainerHeight() {
        if (this.mouseDown) {
          const { height: e } = bs(this.thumbAspectRatio, { width: this.player.media.clientWidth, height: this.player.media.clientHeight });
          return e;
        }
            ...
            this.destroy.call(
              ...
              () => {
                ...
                const { sources: t, type: n } = e,
                  [{ provider: i = Zr.html5, src: r }] = t,
                  s = "html5" === i ? n : "div",
                  o = "html5" === i ? {} : { src: r };
                Object.assign(this, { provider: i, type: n, supported: dr.check(n, i, this.config.playsinline), media: Qi(s, o) }),
                  this.elements.container.appendChild(this.media),
                  Vi.boolean(e.autoplay) && (this.config.autoplay = e.autoplay),
                  this.isHTML5 &&
                    (this.config.crossorigin && this.media.setAttribute("crossorigin", ""),
                    this.config.autoplay && this.media.setAttribute("autoplay", ""),
                    Vi.empty(e.poster) || (this.poster = e.poster),
                    this.config.loop.active && this.media.setAttribute("loop", ""),
                    this.config.muted && this.media.setAttribute("muted", ""),
                    this.config.playsinline && this.media.setAttribute("playsinline", "")),
                  os.addStyleHook.call(this),
                  this.isHTML5 && _s.insertElements.call(this, "source", t),
                  (this.config.title = e.title),
                  fs.setup.call(this),
                  this.isHTML5 && Object.keys(e).includes("tracks") && _s.insertElements.call(this, "track", e.tracks),
                  (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && os.build.call(this),
                  this.isHTML5 && this.media.load(),
                  Vi.empty(e.previewThumbnails) ||
                    ...
                    this.config.previewThumbnails.enabled && (this.previewThumbnails = new ws(this))),
    ...
    class ks {
      constructor(e, t) {
        if (
          (bi(this, "play", () => (Vi.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => _r(this.media.play())), this.media.play()) : null)),
          bi(this, "pause", () => (this.playing && Vi.function(this.media.pause) ? this.media.pause() : null)),
          bi(this, "togglePlay", (e) => ((Vi.boolean(e) ? e : !this.playing) ? this.play() : this.pause())),
          bi(this, "stop", () => {
          ...
          bi(this, "destroy", (e, t = !1) => {
              ...
              (document.body.style.overflow = ""),
                ...
                t
                  ? (Object.keys(this.elements).length &&
                      (er(this.elements.buttons.play),
                      er(this.elements.captions),
                      er(this.elements.controls),
                      er(this.elements.wrapper),
                  ...
                  : (br.call(this),
                    ...
                    vr.call(this, this.elements.original, "destroyed", !0),
                    Vi.function(e) && e.call(this.elements.original),
                    (this.ready = !1),
                    setTimeout(() => {
            ...
            this.stop(),
              ...
              this.isHTML5
                ? (os.toggleNativeControls.call(this, !0), n())
                : this.isYouTube
                ? (clearInterval(this.timers.buffering), clearInterval(this.timers.playing), null !== this.embed && Vi.function(this.embed.destroy) && this.embed.destroy(), n())
                : this.isVimeo && (null !== this.embed && this.embed.unload().then(n), setTimeout(n, 200));
          }),
          bi(this, "supports", (e) => dr.mime.call(this, e)),
          (this.timers = {}),
          (this.ready = !1),
          (this.loading = !1),
          (this.failed = !1),
          (this.touch = dr.touch),
          (this.media = e),
          Vi.string(this.media) && (this.media = document.querySelectorAll(this.media)),
          ((window.jQuery && this.media instanceof jQuery) || Vi.nodeList(this.media) || Vi.array(this.media)) && (this.media = this.media[0]),
          (this.config = Ji(
            {},
            Xr,
            ks.defaults,
          ...
          (this.debug = new is(this.config.debug)),
          this.debug.log("Config", this.config),
          this.debug.log("Support", dr),
          Vi.nullOrUndefined(this.media) || !Vi.element(this.media))
        )
          ...
          case "div":
            if (((r = this.media.querySelector("iframe")), Vi.element(r))) {
              if (
                ...
                const e = ["1", "true"];
                e.includes(s.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                  e.includes(s.searchParams.get("loop")) && (this.config.loop.active = !0),
                  this.isYouTube ? ((this.config.playsinline = e.includes(s.searchParams.get("playsinline"))), (this.config.youtube.hl = s.searchParams.get("hl"))) : (this.config.playsinline = !0);
              }
        ...
        (this.supported = dr.check(this.type, this.provider)),
          this.supported.api
            ? ((this.eventListeners = []),
              (this.listeners = new as(this)),
              (this.storage = new $r(this)),
              (this.media.plyr = this),
              Vi.element(this.elements.container) || ((this.elements.container = Qi("div")), Xi(this.media, this.elements.container)),
              os.migrateStyles.call(this),
              os.addStyleHook.call(this),
              fs.setup.call(this),
              this.config.debug &&
                fr.call(this, this.elements.container, this.config.events.join(" "), (e) => {
                  this.debug.log(`event: ${e.type}`);
                }),
              (this.fullscreen = new rs(this)),
              (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && os.build.call(this),
              this.listeners.container(),
              this.listeners.global(),
              this.config.ads.enabled && (this.ads = new gs(this)),
              this.isHTML5 && this.config.autoplay && this.once("canplay", () => _r(this.play())),
              (this.lastSeekTime = 0),
              this.config.previewThumbnails.enabled && (this.previewThumbnails = new ws(this)))
      ...
      set volume(e) {
        let t = e;
        Vi.string(t) && (t = Number(t)),
          Vi.number(t) || (t = this.storage.get("volume")),
          Vi.number(t) || ({ volume: t } = this.config),
          t > 1 && (t = 1),
          t < 0 && (t = 0),
          (this.config.volume = t),
          (this.media.volume = t),
          !Vi.empty(e) && this.muted && t > 0 && (this.muted = !1);
      }
      get volume() {
      ...
      set pip(e) {
        ...
        Vi.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Gr : Qr),
          Vi.function(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture());
      }
      get pip() {
    ...
    var Ts;
    ks.defaults = ((Ts = Xr), JSON.parse(JSON.stringify(Ts)));
    const Es = {
      video: {
        type: "video",
        ...
        sources: [
          ...
          { src: "https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-1440p.mp4", type: "video/mp4", size: 1440 },
        ],
        poster: "https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg",
        tracks: [
          { kind: "captions", label: "English", srclang: "en", src: "https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.en.vtt", default: !0 },
          { kind: "captions", label: "French", srclang: "fr", src: "https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.fr.vtt" },
        ],
        previewThumbnails: { src: ["https://cdn.plyr.io/static/demo/thumbs/100p.vtt", "https://cdn.plyr.io/static/demo/thumbs/240p.vtt"] },
      },
      audio: {
        type: "audio",
      ...
      youtube: { type: "video", sources: [{ src: "https://youtube.com/watch?v=EEikRc84NhA", provider: "youtube" }] },
      vimeo: { type: "video", sources: [{ src: "https://vimeo.com/335879257", provider: "vimeo" }] },
    };
    (() => {
      const e = "plyr.io";
      window.location.host.includes(e) && Xn({ dsn: "https://d4ad9866ad834437a4754e23937071e4@sentry.io/305555", whitelistUrls: [e].map((e) => new RegExp(`https://(([a-z0-9])+(.))*${e}`)) }),
        document.addEventListener("DOMContentLoaded", () => {
          vi.setup(".js-shr", { count: { className: "button__count" }, wrapper: { className: "button--with-count" } });
          const e = new ks("#player", {
            debug: !0,
            title: "View From A Blue Moon",
            ...
            mediaMetadata: { title: "View From A Blue Moon", album: "Sports", artist: "Brainfarm", artwork: [{ src: "https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg", type: "image/jpeg" }] },
            markers: {
              enabled: !0,
              points: [
          ...
          const s = r.length;
          function o(e) {
            Array.from(t).forEach((e) => e.parentElement.classList.toggle("active", !1)),
              document.querySelector(`[data-source="${e}"]`).classList.toggle("active", !0),
              Array.from(document.querySelectorAll(".plyr__cite")).forEach((e) => {
                e.hidden = !0;
              }),
              (document.querySelector(`.plyr__cite--${e}`).hidden = !1);
          }
          function a(t, i) {
            !n.includes(t) || (!i && t === r) || (!r.length && "video" === t) || ((e.source = Es[t]), (r = t), o(t));
          }
          Array.from(t).forEach((e) => {
            ...
            s || (r = "video"),
            i && n.includes(r) && window.history.replaceState({ type: r }, "", s ? `#${r}` : ""),
            "video" !== r && a(r, !0),
            o(r);
        });
    })();
