...
<section data-bs-version="5.1" class="content15 cid-u8EQxGHr2J" id="content15-9">
    <div class="container">
...
<section data-bs-version="5.1" class="features4 cid-u8E4cicDya" id="features4-0">
    <div class="container">
        <div class="mbr-section-head">
            ...
            <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">Chega de miojo! Descubra receitas que até o ET vai amar!</h5>
        </div>
        <div class="row mt-4">
            <!--<div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <a href="#top"><img src="https://geanramos.com/cdn/assets/images/product2.jpeg" alt="Gean Ramos" title="Gean Ramos"></a>
                    </div>
...
if (isset($_GET['url'])) {
    ...
    $url = "https://gean.me/receita/code/relacionadas2.php?p=" . urlencode($url);
