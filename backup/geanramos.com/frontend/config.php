...
define('description', 'Gean.me e Gean.ml são os encurtadores de URL. O acesso está disponível para convidados - entre em contato com contato@geanramos.com'); 

// The favicon for your site
define('favicon', 'https://cdn.gean.me/ico/favicon-16x16.png');
...
// "TITLE" => "LINK",
$footerLinks = [
    "About"   =>  "https://gean.me/#sobre",
    "Contact" =>  "https://gean.me/#contato",
    "Legal"   =>  "https://gean.me/#termos",
    "Admin"   =>  "/admin/"
];
